...
7. **Docker: Nginx 経由で本番環境** - http://localhost:8080/member をブラウザで開く
8. **Docker: Nginx 経由でデバッグ環境** - http://localhost:8080/member-debug をブラウザで開く
...
2. http://localhost:8080/member-debug でアクセス
...
# Docker環境で本番URIをテスト
docker-compose up -d
open http://localhost:8080/member
