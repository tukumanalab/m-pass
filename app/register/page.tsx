  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-primary-100">
        ...
        <div className="mb-6 p-4 bg-amber-100/90 border-2 border-amber-400 rounded-xl text-amber-950 shadow-sm">
          <p className="font-bold flex items-center gap-2 mb-1.5 text-base text-amber-900">
          ...
          <p className="text-sm leading-relaxed font-medium text-amber-900">
            新規登録後、<strong className="underline decoration-amber-500 font-bold">24時間以内に一度もチェックインが行われない場合</strong>、不要アカウント防止のため登録アカウントは自動削除されます。
          </p>
        </div>
