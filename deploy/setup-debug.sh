...
echo "- 本番環境 Nginx: https://tukumana.si.aoyama.ac.jp/member"
echo "- デバッグ環境 Nginx: https://tukumana.si.aoyama.ac.jp/member-debug"
echo ""
echo "PM2コマンド："
...
echo ""
echo "デバッグ環境のデータベースは別ファイル (checkin-debug.db) に保存されます。"
echo ""
